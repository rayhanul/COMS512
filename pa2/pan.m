...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 4: // STATE 10 - _spin_nvr.tmp:8 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Intruder */
	case 5: // STATE 1 - PA2-P1-rayhanul.pml:71 - [network?msg,_,data.key,data.info1,data.info2] (0:0:6 - 1)
		reached[2][1] = 1;
		...
		if (!readtrail)
			...
			((P2 *)_this)->msg = 0;
		_m = 4; goto P999; /* 0 */
	case 6: // STATE 2 - PA2-P1-rayhanul.pml:73 - [intercepted.key = data.key] (0:24:3 - 1)
		IfNotBlocked
		reached[2][2] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 7: // STATE 8 - PA2-P1-rayhanul.pml:77 - [((data.key==keyI))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][8] = 1;
		if (!((((P2 *)_this)->data.key==7)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 8: // STATE 9 - PA2-P1-rayhanul.pml:79 - [(((data.info1==nonceA)||(data.info2==nonceA)))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][9] = 1;
		if (!(((((P2 *)_this)->data.info1==3)||(((P2 *)_this)->data.info2==3))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 10 - PA2-P1-rayhanul.pml:79 - [knows_nonceA = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][10] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 15 - PA2-P1-rayhanul.pml:83 - [((data.key==keyI))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][15] = 1;
		if (!((((P2 *)_this)->data.key==7)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 16 - PA2-P1-rayhanul.pml:85 - [(((data.info1==nonceB)||(data.info2==nonceB)))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][16] = 1;
		if (!(((((P2 *)_this)->data.info1==2)||(((P2 *)_this)->data.info2==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 17 - PA2-P1-rayhanul.pml:85 - [knows_nonceB = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][17] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 26 - PA2-P1-rayhanul.pml:93 - [msg = msg1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][26] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 27 - PA2-P1-rayhanul.pml:94 - [msg = msg2] (0:0:1 - 1)
		IfNotBlocked
		reached[2][27] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->msg;
		((P2 *)_this)->msg = 11;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 28 - PA2-P1-rayhanul.pml:95 - [msg = msg3] (0:0:1 - 1)
		IfNotBlocked
		reached[2][28] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->msg;
		((P2 *)_this)->msg = 10;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 16: // STATE 31 - PA2-P1-rayhanul.pml:98 - [recpt = agentA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][31] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 17: // STATE 32 - PA2-P1-rayhanul.pml:99 - [recpt = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][32] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->recpt;
		((P2 *)_this)->recpt = 5;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 18: // STATE 35 - PA2-P1-rayhanul.pml:102 - [data.key = intercepted.key] (0:70:3 - 1)
		IfNotBlocked
		reached[2][35] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 3 */
	case 19: // STATE 38 - PA2-P1-rayhanul.pml:104 - [data.info1 = agentA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][38] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 20: // STATE 39 - PA2-P1-rayhanul.pml:105 - [data.info1 = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][39] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 21: // STATE 40 - PA2-P1-rayhanul.pml:106 - [data.info1 = agentI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][40] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 22: // STATE 41 - PA2-P1-rayhanul.pml:107 - [(knows_nonceA)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][41] = 1;
		if (!(((int)now.knows_nonceA)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 23: // STATE 42 - PA2-P1-rayhanul.pml:107 - [data.info1 = nonceA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][42] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 24: // STATE 43 - PA2-P1-rayhanul.pml:108 - [(knows_nonceB)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][43] = 1;
		if (!(((int)now.knows_nonceB)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 25: // STATE 44 - PA2-P1-rayhanul.pml:108 - [data.info1 = nonceB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][44] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 26: // STATE 45 - PA2-P1-rayhanul.pml:109 - [data.info1 = nonceI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][45] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 27: // STATE 48 - PA2-P1-rayhanul.pml:113 - [data.info2 = agentA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][48] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 28: // STATE 49 - PA2-P1-rayhanul.pml:114 - [data.info2 = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][49] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 29: // STATE 50 - PA2-P1-rayhanul.pml:115 - [data.info2 = agentI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][50] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 30: // STATE 51 - PA2-P1-rayhanul.pml:116 - [(knows_nonceA)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][51] = 1;
		if (!(((int)now.knows_nonceA)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 31: // STATE 52 - PA2-P1-rayhanul.pml:116 - [data.info2 = nonceA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][52] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 32: // STATE 53 - PA2-P1-rayhanul.pml:117 - [(knows_nonceB)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][53] = 1;
		if (!(((int)now.knows_nonceB)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 33: // STATE 54 - PA2-P1-rayhanul.pml:117 - [data.info2 = nonceB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][54] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 34: // STATE 55 - PA2-P1-rayhanul.pml:118 - [data.info2 = nonceI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][55] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.info2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 35: // STATE 58 - PA2-P1-rayhanul.pml:122 - [data.key = keyA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][58] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 36: // STATE 59 - PA2-P1-rayhanul.pml:123 - [data.key = keyB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][59] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.key;
		((P2 *)_this)->data.key = 8;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 37: // STATE 60 - PA2-P1-rayhanul.pml:124 - [data.key = keyI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][60] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.key;
		((P2 *)_this)->data.key = 7;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 38: // STATE 61 - PA2-P1-rayhanul.pml:125 - [(knows_nonceA)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][61] = 1;
		if (!(((int)now.knows_nonceA)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 39: // STATE 62 - PA2-P1-rayhanul.pml:125 - [data.key = nonceA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][62] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.key;
		((P2 *)_this)->data.key = 3;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 40: // STATE 63 - PA2-P1-rayhanul.pml:126 - [(knows_nonceB)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][63] = 1;
		if (!(((int)now.knows_nonceB)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 41: // STATE 64 - PA2-P1-rayhanul.pml:126 - [data.key = nonceB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][64] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.key;
		((P2 *)_this)->data.key = 2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 42: // STATE 65 - PA2-P1-rayhanul.pml:127 - [data.key = nonceI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][65] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.key;
		((P2 *)_this)->data.key = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 43: // STATE 70 - PA2-P1-rayhanul.pml:132 - [network!msg,recpt,data.key,data.info1,data.info2] (0:0:0 - 23)
		IfNotBlocked
		reached[2][70] = 1;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 44: // STATE 74 - PA2-P1-rayhanul.pml:134 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][74] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Bob */
	case 45: // STATE 1 - PA2-P1-rayhanul.pml:46 - [network?msg1,agentB,data.key,data.info1,data.info2] (0:0:3 - 1)
		reached[1][1] = 1;
		if (boq != now.network) continue;
		if (q_len(now.network) == 0) continue;
		...
		_m = 4; goto P999; /* 0 */
	case 46: // STATE 2 - PA2-P1-rayhanul.pml:48 - [((((data.key==keyB)&&(data.info2==nonceA))&&(data.info1==agentA)))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		if (!((((((P1 *)_this)->data.key==8)&&(((P1 *)_this)->data.info2==3))&&(((P1 *)_this)->data.info1==6))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 47: // STATE 3 - PA2-P1-rayhanul.pml:49 - [partnerB = data.info1] (0:0:1 - 1)
		IfNotBlocked
		reached[1][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 48: // STATE 4 - PA2-P1-rayhanul.pml:50 - [pnonce = data.info2] (0:0:1 - 1)
		IfNotBlocked
		reached[1][4] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 49: // STATE 5 - PA2-P1-rayhanul.pml:52 - [partnerA = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[1][5] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 50: // STATE 6 - PA2-P1-rayhanul.pml:52 - [pkey = keyB] (0:15:4 - 1)
		IfNotBlocked
		reached[1][6] = 1;
...
#endif
		;
		/* merge: data2.info1 = pnonce(15, 13, 15) */
		reached[1][13] = 1;
...
#endif
		;
		/* merge: data2.info2 = nonceB(15, 14, 15) */
		reached[1][14] = 1;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 51: // STATE 7 - PA2-P1-rayhanul.pml:53 - [partnerA = agentI] (0:0:1 - 1)
		IfNotBlocked
		reached[1][7] = 1;
		(trpt+1)->bup.oval = now.partnerA;
		now.partnerA = 4;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 52: // STATE 8 - PA2-P1-rayhanul.pml:53 - [pkey = keyI] (0:15:4 - 1)
		IfNotBlocked
		reached[1][8] = 1;
		(trpt+1)->bup.ovals = grab_ints(4);
		(trpt+1)->bup.ovals[0] = ((P1 *)_this)->pkey;
		...
		;
		_m = 3; goto P999; /* 5 */
	case 53: // STATE 11 - PA2-P1-rayhanul.pml:56 - [] (0:15:3 - 3)
		IfNotBlocked
		reached[1][11] = 1;
		;
		/* merge: data2.key = pkey(15, 12, 15) */
		...
		;
		_m = 3; goto P999; /* 3 */
	case 54: // STATE 15 - PA2-P1-rayhanul.pml:57 - [network!msg2,partnerB,data2.key,data2.info1,data2.info2] (0:0:0 - 1)
		IfNotBlocked
		reached[1][15] = 1;
		if (q_len(now.network))
			continue;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 55: // STATE 16 - PA2-P1-rayhanul.pml:59 - [network?msg3,agentB,data.key,data.info1,data.info2] (0:0:3 - 1)
		reached[1][16] = 1;
		if (boq != now.network) continue;
		if (q_len(now.network) == 0) continue;
		...
		_m = 4; goto P999; /* 0 */
	case 56: // STATE 17 - PA2-P1-rayhanul.pml:60 - [(((data.key==keyB)&&(data.info1==nonceB)))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][17] = 1;
		if (!(((((P1 *)_this)->data.key==8)&&(((P1 *)_this)->data.info1==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 57: // STATE 18 - PA2-P1-rayhanul.pml:61 - [statusB = ok] (0:0:1 - 1)
		IfNotBlocked
		reached[1][18] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 58: // STATE 19 - PA2-P1-rayhanul.pml:62 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][19] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Alice */
	case 59: // STATE 1 - PA2-P1-rayhanul.pml:24 - [partnerA = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		(trpt+1)->bup.oval = now.partnerA;
		now.partnerA = 5;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 60: // STATE 2 - PA2-P1-rayhanul.pml:24 - [pkey = keyB] (0:10:4 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		(trpt+1)->bup.ovals = grab_ints(4);
		...
		;
		_m = 3; goto P999; /* 4 */
	case 61: // STATE 3 - PA2-P1-rayhanul.pml:25 - [partnerA = agentI] (0:0:1 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		(trpt+1)->bup.oval = now.partnerA;
		now.partnerA = 4;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 62: // STATE 4 - PA2-P1-rayhanul.pml:25 - [pkey = keyI] (0:10:4 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		(trpt+1)->bup.ovals = grab_ints(4);
		(trpt+1)->bup.ovals[0] = ((P0 *)_this)->pkey;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 63: // STATE 7 - PA2-P1-rayhanul.pml:28 - [data.key = pkey] (0:10:3 - 3)
		IfNotBlocked
		reached[0][7] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 64: // STATE 10 - PA2-P1-rayhanul.pml:30 - [network!msg1,partnerA,data.key,data.info1,data.info2] (0:0:0 - 1)
		IfNotBlocked
		reached[0][10] = 1;
		if (q_len(now.network))
			continue;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 65: // STATE 11 - PA2-P1-rayhanul.pml:32 - [network?msg2,agentA,data2.key,data2.info1,data2.info2] (0:0:3 - 1)
		reached[0][11] = 1;
		if (boq != now.network) continue;
		if (q_len(now.network) == 0) continue;
		...
		_m = 4; goto P999; /* 0 */
	case 66: // STATE 12 - PA2-P1-rayhanul.pml:33 - [(((data2.key==pkey)&&(data2.info1==nonceA)))] (17:0:4 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		if (!(((((P0 *)_this)->data2.key==((P0 *)_this)->pkey)&&(((P0 *)_this)->data2.info1==3))))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 67: // STATE 17 - PA2-P1-rayhanul.pml:37 - [network!msg3,partnerA,data3.key,data3.info1,data3.info2] (0:0:0 - 1)
		IfNotBlocked
		reached[0][17] = 1;
		if (q_len(now.network))
			continue;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 68: // STATE 18 - PA2-P1-rayhanul.pml:38 - [statusA = ok] (0:0:1 - 1)
		IfNotBlocked
		reached[0][18] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 69: // STATE 19 - PA2-P1-rayhanul.pml:39 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][19] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
