...
/*** From source: pa_2_frogs_N_9.pml ***/
...
short src_ln1 [] = {
	...
	176, 177, 178, 180, 182, 183, 184, 185, 
	186, 187, 188, 189, 194,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "pa_2_frogs_N_9.pml", 1, 20 },
	{ "-", 21, 22 }
};
uchar reached1 [] = {
	  0,   0,   0,   0,   0,   0,   0,   0, 
...
short src_ln0 [] = {
	  0,  47,  39,  40,  40,  40,  38,  37, 
	 39,  40,  40,  40,  38,  37,  47,  51, 
	 51,  32,  33,  33,  33,  31,  30,  39, 
	 40,  40,  40,  38,  37,  39,  40,  40, 
	 40,  38,  37,  51,  57,  57,  32,  33, 
	 33,  33,  31,  30,  32,  33,  33,  33, 
	 31,  30,  39,  40,  40,  40,  38,  37, 
	 39,  40,  40,  40,  38,  37,  57,  63, 
	 63,  32,  33,  33,  33,  31,  30,  32, 
	 33,  33,  33,  31,  30,  39,  40,  40, 
	 40,  38,  37,  39,  40,  40,  40,  38, 
	 37,  63,  69,  69,  32,  33,  33,  33, 
	 31,  30,  32,  33,  33,  33,  31,  30, 
	 39,  40,  40,  40,  38,  37,  39,  40, 
	 40,  40,  38,  37,  69,  76,  76,  32, 
	 33,  33,  33,  31,  30,  32,  33,  33, 
	 33,  31,  30,  39,  40,  40,  40,  38, 
	 37,  39,  40,  40,  40,  38,  37,  76, 
	 82,  82,  32,  33,  33,  33,  31,  30, 
	 32,  33,  33,  33,  31,  30,  39,  40, 
	 40,  40,  38,  37,  39,  40,  40,  40, 
	 38,  37,  82,  88,  88,  32,  33,  33, 
	 33,  31,  30,  32,  33,  33,  33,  31, 
	 30,  39,  40,  40,  40,  38,  37,  39, 
	 40,  40,  40,  38,  37,  88,  95,  95, 
	 32,  33,  33,  33,  31,  30,  32,  33, 
	 33,  33,  31,  30,  39,  40,  40,  40, 
	 38,  37,  39,  40,  40,  40,  38,  37, 
	 95, 101, 101,  32,  33,  33,  33,  31, 
	 30,  32,  33,  33,  33,  31,  30,  39, 
	 40,  40,  40,  38,  37,  39,  40,  40, 
	 40,  38,  37, 101, 108, 108,  32,  33, 
	 33,  33,  31,  30,  32,  33,  33,  33, 
	 31,  30,  39,  40,  40,  40,  38,  37, 
	 39,  40,  40,  40,  38,  37, 108, 114, 
	114,  32,  33,  33,  33,  31,  30,  32, 
	 33,  33,  33,  31,  30,  39,  40,  40, 
	 40,  38,  37,  39,  40,  40,  40,  38, 
	 37, 114, 120, 120,  32,  33,  33,  33, 
	 31,  30,  32,  33,  33,  33,  31,  30, 
	 39,  40,  40,  40,  38,  37,  39,  40, 
	 40,  40,  38,  37, 120, 126, 126,  32, 
	 33,  33,  33,  31,  30,  32,  33,  33, 
	 33,  31,  30,  39,  40,  40,  40,  38, 
	 37,  39,  40,  40,  40,  38,  37, 126, 
	133, 133,  32,  33,  33,  33,  31,  30, 
	 32,  33,  33,  33,  31,  30,  39,  40, 
	 40,  40,  38,  37,  39,  40,  40,  40, 
	 38,  37, 133, 139, 139,  32,  33,  33, 
	 33,  31,  30,  32,  33,  33,  33,  31, 
	 30,  39,  40,  40,  40,  38,  37,  39, 
	 40,  40,  40,  38,  37, 139, 145, 145, 
	 32,  33,  33,  33,  31,  30,  32,  33, 
	 33,  33,  31,  30,  39,  40,  40,  40, 
	 38,  37,  39,  40,  40,  40,  38,  37, 
	145, 152, 152,  32,  33,  33,  33,  31, 
	 30,  32,  33,  33,  33,  31,  30,  39, 
	 40,  40,  40,  38,  37, 152, 157, 157, 
	 32,  33,  33,  33,  31,  30,  32,  33, 
	 33,  33,  31,  30, 157, 161,  46, 163, 
	 46, 163,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "pa_2_frogs_N_9.pml", 1, 481 },
	{ "-", 482, 483 }
};
uchar reached0 [] = {
	  0,   1,   1,   0,   0,   0,   1,   1, 
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		for (l_in = 0; l_in < 19; l_in++)
		{
			logval("stones[l_in]", now.stones[l_in]);
		}
	}
#endif
}
...
{	/* int i; */
	...
	printf("	mtype  none:	3\n");
	printf("	mtype  male:	2\n");
	printf("	mtype  female:	1\n");
	{	int l_in;
		for (l_in = 0; l_in < 19; l_in++)
		{
			printf("	mtype  stones[%d]:	%d\n", l_in, now.stones[l_in]);
		}
	}
}
void
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("female"); return;
	case 2: Printf("male"); return;
	case 3: Printf("none"); return;
