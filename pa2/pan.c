...
short src_ln2 [] = {
	...
	117, 118, 118, 119, 120, 121, 122, 117, 
	124, 117, 106, 125,   0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "PA2-P2-rayhanul.pml", 1, 19 },
	{ "-", 20, 21 }
};
uchar reached2 [] = {
	  0,   1,   0,   0,   0,   0,   0,   0, 
...
short src_ln1 [] = {
	  0,  78,  79,  79,  79,  79,  77,  75, 
	 86,  87,  87,  87,  87,  85,  83,  99, 
	103,  99, 103,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "PA2-P2-rayhanul.pml", 1, 18 },
	{ "-", 19, 20 }
};
uchar reached1 [] = {
	  0,   1,   0,   0,   0,   0,   1,   1, 
...
short src_ln0 [] = {
	  0,  62,  63,  63,  63,  63,  61,  59, 
	 70,  71,  71,  71,  71,  69,  67,  92, 
	 96,  92,  96,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "PA2-P2-rayhanul.pml", 1, 18 },
