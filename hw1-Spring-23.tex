...
The above Kripke structure satisfies $\af{p} \land \af{q}$, but it does not satisfies $\af{p \land q}$. Therefore, it canbe said that these two properties are not equivalent. 
